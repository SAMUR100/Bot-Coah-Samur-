...
def webhook():
    ...
    respostas = {
        "ed": "ED significa Educativos de corrida. São exercícios técnicos que simulam gestos da corrida e ajudam a ativar a musculatura e melhorar a técnica. Estão disponíveis em 'Rotina de Educativos'.",
        ...
        "feedback": "O feedback é essencial! Após cada treino, finalize na plataforma MFit, descreva o esforço, cole link do Strava ou Garmin, e como se sentiu. Isso ajuda a ajustar os treinos futuros.",
